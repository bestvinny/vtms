                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar-collapse" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a id="user-profile" href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="http://lorempixel.com/100/100/people/9/" class="img-responsive img-thumbnail img-circle">Hello, {{ Auth::user()->name }} <b class="fa fa-angle-down"></b></a>
                                <ul class="dropdown-menu dropdown-block" role="menu">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="{{ route('adminlogout') }}"><i class="fa fa-fw fa-power-off"></i>Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
